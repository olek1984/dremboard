...
<?php
	...
	public static function buddypress_content() {
	    ...
	    ?>
		    ...
		    */
		    ?>
		    <h3 class="hndle"><span>Memory Settings</span></h3>
		    <?php
		    $options = $rtmedia->options;
		    $render_options = array(
			'general_enableAlbums' => array(
				    //!!! 'title' => __('Organize media into albums','rtmedia'),
				    'title' => __('Organize media into memories','rtmedia'),
				    'callback' => array('RTMediaFormHandler', 'checkbox'),
				    'args' => array(
					    ...
					    'desc' => __('This will add \'memory\' tab to BuddyPress profile and group depending on ^above^ settings.','rtmedia')
				    )
			),
		    );
