            ...
            var rtnObj;
             try {
                ...
                if(rtnObj.permalink != ''){
                    ...
                    //!!!!!!
                    $('.plupload_media_edit').fadeIn();
                    $('.plupload_media_edit').fadeOut();
                    $('.plupload_media_edit').fadeIn();
                }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.count > 0){
                    ...
                    //!!!!!
   checknow = $(".my-like");
    $(checknow).removeClass('my-like');
    $(checknow).addClass('my-unlike');
    $(checknow).removeAttr('title');
    $(checknow).attr('title','Unlike this');
                }else {
                    $('.rtmedia-like-info').addClass('hide');
                    //!!!!!
   checknow = $(".my-unlike");
    $(checknow).removeClass('my-unlike');
    $(checknow).addClass('my-like');
    $(checknow).removeAttr('title');
    $(checknow).attr('title','Like this');    
                }
            }
        });
