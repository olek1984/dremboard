		...
		public function plugins_content($args = '') {
			...
			$addons = array(
				 array(
                    ...
                    'title' => __('rtMedia Drēm Tagging', 'rtmedia'),
                    ...
                    'desc' => '<p>' . __('rtMedia Drēm Tagging add-on enables tagging on drēms uploaded using BuddyPress Media.', 'rtmedia') . '</p>
			...
			foreach ($addons as $key => $value) {
				...
				if($key == 0) {
					...
					_e( 'rtMedia Addons for Drēms', 'rtmedia' );
					echo '</h3>';
				} else if($key == 2) {
					echo '<h3>';
