...
class RTMedia
{
    ...
    function custome_style_for_activity_image_size() {
        ...
        <style>
            ...
            .rtmedia-container .rtmedia-list  .rtmedia-list-item.has-author {
                width: <?php echo intval($this->options["defaultSizes_photo_thumbnail_width"]) + 20; ?>px;
                height: <?php echo intval($this->options["defaultSizes_photo_thumbnail_height"]) + 90; ?>px;
            }
        </style>
        <?php
    }
    ...
    function set_allowed_types() {
        $allowed_types = array(
            'photo' => array(
                ...
                'label' => __('Drēm', 'rtmedia'),
                //!!!'plural_label' => __('Photos', 'rtmedia'),
                'plural_label' => __('Drēms', 'rtmedia'),
    ...
    function set_privacy() {
        ...
        $this->privacy_settings = array(
            'levels' => array(
                ...
                50 => __('<strong>Family</strong> - Visible to user\'s family', 'rtmedia'),
