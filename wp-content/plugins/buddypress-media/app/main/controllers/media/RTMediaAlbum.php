...
class RTMediaAlbum {
    ...
    function register_post_types () {
		...
		*/
        $album_labels = array(
            //***'name' => __ ( 'Memories', 'rtmedia' ),
            'name' => __ ( 'Drēmcast', 'rtmedia' ),
            'singular_name' => __ ( 'Memory', 'rtmedia' ),
            'add_new' => __ ( 'Create', 'rtmedia' ),
            'add_new_item' => __ ( 'Create Memory', 'rtmedia' ),
            //!!!!! 'edit_item' => __ ( 'Edit Memory', 'rtmedia' ),
            'edit_item' => __ ( 'Edit It', 'rtmedia' ),
            //!!!!!'new_item' => __ ( 'New Memory', 'rtmedia' ),
            'new_item' => __ ( 'New Item', 'rtmedia' ),
            //!!!!! 'all_items' => __ ( 'All Memories', 'rtmedia' ),
            'all_items' => __ ( 'All Items', 'rtmedia' ),
            //!!!!! 'view_item' => __ ( 'View Memory', 'rtmedia' ),
            'view_item' => __ ( 'View It', 'rtmedia' ),
            //!!!!! 'search_items' => __ ( 'Search Memories', 'rtmedia' ),
            'search_items' => __ ( 'Search Items', 'rtmedia' ),
            //!!!!! 'not_found' => __ ( 'No memory found', 'rtmedia' ),
            'not_found' => __ ( 'Not found', 'rtmedia' ),
            //!!!!! 'not_found_in_trash' => __ ( 'No memory found in Trash', 'rtmedia' ),
            'not_found_in_trash' => __ ( 'Not found in Trash', 'rtmedia' ),
            'parent_item_colon' => __('Parent','rtmedia'),
            //***'menu_name' => __ ( 'Memories', 'rtmedia' )
            'menu_name' => __ ( 'Drēmcast', 'rtmedia' )
        );
    ...
    {
    	global $wpdb;
    	update_option("test1001",$album_dremboard_type);
    	update_option("test1002",$category);
    	update_option("test1003",$description);
    	update_option("test1004",$privacy);
	...
	//$creat_album_dremboard_type = jQuery.trim(jQuery('#creat_album_dremboard_type').val());
        ...
        $post_vars = array(
            ...
            'post_title' => (empty ( $title )) ? __( 'Untitled Memory', 'rtmedia' ) : $title,
        ...
        {
        	wp_set_post_categories($album_id,$category);
        }
	...
	$rtmedia_points_media_id = $rtmedia_id;
        ...
        //!!!!!
        /* public: NULL; personal: 60; family: 50; friend: 40*/
        
        $privacy_num = 0;
        if ($privacy == 'YES' || $privacy == 'PERSONAL'){
        	$privacy_num = 60;
        ...
        if ($privacy_num != 0)
        {
			...
			$update_sql = "UPDATE $model->table_name SET privacy = '".$privacy_num."' where id = $rtmedia_id ";
