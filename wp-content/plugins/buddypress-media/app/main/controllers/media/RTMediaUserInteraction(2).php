			...
			$button_start = '<form action="'. $link .'">';
					...
					.' rtmedia-action-buttons button'.$disabled.'">' . $icon . '<span>' . $this->label.'</span></button>';
                        */
                        ...
                        $button = '<button type="submit" id="rtmedia-action-button-'.$this->media->id.'" class="my-unlike rtmedia-'.$this->action
					.' rtmedia-action-buttons button'.$disabled.'" title="Unlike this">' . $icon . '<span>' . $this->label.'</span></button>';
							/*
							//!!!!!
                        $button = '<button type="submit" id="rtmedia-action-button-'.$this->media->id.'" class="rtmedia-unlike'
					.' rtmedia-action-buttons button'.$disabled.'">' . $icon . '<span>' . $this->label.'</span></button>';
					*/
						}
						else 
						{
                        $button = '<button type="submit" id="rtmedia-action-button-'.$this->media->id.'" class="my-like rtmedia-'.$this->action
					.' rtmedia-action-buttons button'.$disabled.'" title="Like this">' . $icon . '<span>' . $this->label.'</span></button>';
						}
