...
/**
 * Flag Activity\'s content will be sent using this Email address
 *
 * @since JinXinZhi 
 */
function bp_admin_setting_callback_flag_email_address() {
    $value = get_option( 'bp-flag-mail-address', '' );
?>
    <input id="bp-flag-mail-address" name="bp-flag-mail-address" type="text" value="<?php echo $value; ?>"  size="40"/>
	<label for="bp-flag-mail-address"><?php _e( 'Flag Activity\'s content will be sent using this Email address', 'buddypress' ); ?></label>
<?php
}


/**
 * Copy Right Activity\'s content will be sent using this Email address
 *
 * @since JinXinZhi 
 */
function bp_admin_setting_callback_copyright_email_address() {
    $value = get_option( 'bp-copyright-mail-address', '' );
?>
	<input id="bp-copyright-mail-address" name="bp-copyright-mail-address" type="text" value="<?php echo $value; ?>" size="40"/>
	<label for="bp-copyright-mail-address"><?php _e( 'Copyright Activity\'s content will be sent using this Email address', 'buddypress' ); ?></label>
<?php
}
/**
