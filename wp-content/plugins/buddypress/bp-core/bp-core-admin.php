...
class BP_Admin {
	...
	public function register_admin_settings() {
		...
		if ( bp_is_active( 'activity' ) ) {
            ...
            // Flag Activity mail address.
			add_settings_field( 'bp-flag-mail-address', __( 'Flag Email Address', 'buddypress' ), 'bp_admin_setting_callback_flag_email_address', 'buddypress', 'bp_activity' );
			register_setting( 'buddypress', 'bp-flag-mail-address' );
            
            // CopyRight Activity mail address.
			add_settings_field( 'bp-copyright-mail-address', __( 'CopyRight Email Address', 'buddypress' ), 'bp_admin_setting_callback_copyright_email_address', 'buddypress', 'bp_activity' );
			register_setting( 'buddypress', 'bp-copyright-mail-address' );
		}
	}
