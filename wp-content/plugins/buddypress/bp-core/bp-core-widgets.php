...
class BP_Core_Members_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			'description' => __( 'A dynamic list of recently active, family, and friends members', 'buddypress' ),
	...
	function widget( $args, $instance ) {
		...
		<?php if ( bp_has_members( 'user_id=0&type=' . $instance['member_default'] . '&max=' . $instance['max_members'] . '&populate_extras=1' ) ) : ?>
			<div class="item-options" id="members-list-options">
				<a href="<?php bp_members_directory_permalink(); ?>" id="active-members" <?php if ( $instance['member_default'] == 'active' ) : ?>class="selected"<?php endif; ?>><?php _e( 'Active', 'buddypress' ) ?></a>
				|  <a href="<?php bp_members_directory_permalink(); ?>" id="family-members" <?php if ( $instance['member_default'] == 'family' ) : ?>class="selected"<?php endif; ?>><?php _e( 'Family', 'buddypress' ) ?></a>

				<?php if ( bp_is_active( 'friends' ) ) : ?>

					| <a href="<?php bp_members_directory_permalink(); ?>" id="friends-members" <?php if ( $instance['member_default'] == 'friends' ) : ?>class="selected"<?php endif; ?>><?php _e( 'Friends', 'buddypress' ) ?></a>
	...
	function form( $instance ) {
		...
		<p>
			...
			<select name="<?php echo $this->get_field_name( 'member_default' ) ?>">
				...
				<option value="family" <?php if ( $member_default == 'family' ) : ?>selected="selected"<?php endif; ?>><?php _e( 'Family', 'buddypress' ) ?></option>
				<option value="friends" <?php if ( $member_default == 'friends' ) : ?>selected="selected"<?php endif; ?>><?php _e( 'Friends', 'buddypress' ) ?></option>
			</select>
			</label>
		</p>
...
function bp_core_ajax_widget_members() {
	...
	if ( bp_has_members( 'user_id='. $user_id .'&type=' . $type . '&per_page=' . $_POST['max-members'] . '&max=' . $_POST['max-members'] . '&populate_extras=1' ) ) : ?>
