...
function bp_core_screen_signup_action($rest_api = false){
	...
	if ( !empty( $bp->signup->errors ) ) {
		if ($rest_api){
			return array("status" => "error", "data" => $bp->signup->errors);
		}
		...
		if ($rest_api){
			return array("status" => "ok", "msg" => "please check your mail");
		}
	}
