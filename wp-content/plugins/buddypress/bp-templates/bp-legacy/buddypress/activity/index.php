...
<div id="buddypress">
	...
	<div class="item-list-tabs activity-type-tabs <?php if($is_mobile)echo 'mobile mobile_sub_menu'; ?>" role="navigation">
		<?php if( $is_mobile ): ?>
		<ul class="has_sub">
			<li class="has_sub"><a onclick="javascript:;">All Activities</a></li>
		</ul>	
		<?php endif; ?>
		<ul class="sub">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<li id="activity-notifications">
					<a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/notifications/'; ?>" title="<?php _e( 'Activity that sent me as notification', 'buddypress' ); ?>">
						<?php _e( 'Notifications', 'buddypress' ); ?>
						<?php if ( $count > 0 ) : ?>
							<span><?php echo number_format_i18n($count); ?></span>
						<?php endif; ?>
					</a>
				</li>
