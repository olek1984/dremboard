			...
			<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
				...
				<li>
					...
					<div class="action">
						...
						<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'link_class' => 'accept button', 'link_href' => bp_get_group_request_accept_link(), 'link_title' => __( 'Accept', 'buddypress' ), 'link_text' => __( 'Accept', 'buddypress' ), 'wrapper' => false ) ); ?>

						<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'link_class' => 'reject button', 'link_href' => bp_get_group_request_reject_link(), 'link_title' => __( 'Reject', 'buddypress' ), 'link_text' => __( 'Reject', 'buddypress' ), 'wrapper' => false ) ); ?>
