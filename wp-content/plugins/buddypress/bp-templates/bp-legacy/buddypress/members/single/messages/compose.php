<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<ul class="first acfb-holder helper-input">
		<li>
			<?php bp_message_get_recipient_tabs(); ?>
			<input type="text" name="send-to-input" class="send-to-input helper-input-box" id="send-to-input" autocomplete="off"/>
		</li>
	</ul>
	...
	<textarea name="content" id="message_content" rows="15" cols="40" class="helper-input helper-input-box has_mark"><?php bp_messages_content_value(); ?></textarea>
