<?php
	...
	$this->settings['license_heading'] = array(
		'section' 	=> 'wsi_general',
		'std'   	=> __( 'License Key' , $this->WPB_PREFIX), // Not used for headings.
		'title'		=> '',
		'desc'   	=> "<p>".__('Enter the license key. You can find your license in your <a href="http://wp.timersys.com/checkout/purchase-history/" target="_blank">purchase history page</a>',$this->WPB_PREFIX)."</p>",
		'class'	 	=> '',
		'type'   	=> 'heading'
	);
	
	$this->settings['wsi_license_key'] = array(
			'title'   => __( 'License Key' , $this->WPB_PREFIX),
			'desc'    => get_option('wsi_license_active' ) == 'valid'? __('Thanks for purchasing WSI', $this->WPB_PREFIX) : '<div style="color:red">'.__('Invalid key! Check your license', $this->WPB_PREFIX).'</div>',
			'std'     => '',
			'type'    => 'text',
			'class'	  => get_option('wsi_license_active' ) == 'valid'? 'wsi-valid-key' : 'wsi-invalid-key',
			'section' => 'wsi_general'
	...
	$this->settings['redirect_url'] = array(
			'title'   => __( '"Redirect to" URL' , $this->WPB_PREFIX),
	...
	$this->settings['enable_facebook'] = array(
		...
		'desc'    => __( 'Enable / Disable Facebook Invitations.' , $this->WPB_PREFIX),
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['facebook_share_url'] = array(
		...
		'desc'    => __( 'Wich url you want to share. You can change this with filters' , $this->WPB_PREFIX),
		'std'     => 'registration',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	$this->settings['enable_twitter'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Twitter Invitations.' , $this->WPB_PREFIX),
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
...
$this->settings['g_heading'] = array(
	...
	$this->settings['enable_linkedin'] = array(
		'title'   => __( 'Enabled' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable Linkedin Invitations.' , $this->WPB_PREFIX),
		'std'     => 'false',
		'type'    => 'select',
		'section' => 'wsi_general',
		'choices' => array(
	...
	*/
	...
	$this->settings['subject_editable'] = array(
		...
		'desc'    => __( 'Enable / Disable users to change the default subject. Facebook, Twitter and Linkedin don\'t use subject field' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_messages',
		'choices' => array(
	...
	$this->settings['html_message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default html message.' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_messages',
		'choices' => array(
	...
	$this->settings['footer'] = array(
		...
		'desc'    => __('The footer it\'s only used by email providers. A good practice is to add your company address to avoid spam filters' ,$this->WPB_PREFIX),
	...
	$this->settings['default_heading2'] = array(
		'section' 	=> 'wsi_messages',
		'std'   	=> __( 'Linkedin Default Message.' , $this->WPB_PREFIX), // Not used for headings.
		'title'		=> '',
		'desc'   	=> __( 'Linkedin message don\'t allow HTML and needs to be shorter than 200 characters' , $this->WPB_PREFIX),
		'class'	 	=> '',
		'type'   	=> 'heading'
	);	
	...
	$this->settings['text_subject_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default subject. Linkedin policy says that users must be able to edit this' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_messages',
		'choices' => array(
	...
	$this->settings['message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default message. Linkedin policy says that users must be able to edit this' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_messages',
		'choices' => array(
	...
	$this->settings['fb_title'] = array(
		'title'   => __( 'Facebook Title' , $this->WPB_PREFIX),
		'desc'    => sprintf(__('Facebook sharing title used on login page. Read more <a href="%s" target="_blank">here</a>',$this->WPB_PREFIX), 'http://wp.timersys.com/wordpress-social-invitations/docs/defaults-messages/#facebook'),
	...
	$this->settings['fb_message'] = array(
		'title'   => __( 'Facebook Message' , $this->WPB_PREFIX),
		'desc'    => sprintf(__('Facebook sharing text used on login page. Read more <a href="%s" target="_blank">here</a>',$this->WPB_PREFIX), 'http://wp.timersys.com/wordpress-social-invitations/docs/defaults-messages/#facebook'),
		'std'     => __('Please accept the invitation!', $this->WPB_PREFIX),
		'type'    => 'textarea',
		'section' => 'wsi_messages'
	);
	...
	$this->settings['tw_message_editable'] = array(
		'title'   => __( 'Editable' , $this->WPB_PREFIX),
		'desc'    => __( 'Enable / Disable users to change the default Twitter message.' , $this->WPB_PREFIX),
		'std'     => 'true',
		'type'    => 'select',
		'section' => 'wsi_messages',
		'choices' => array(
	...
	*/
	...
	$this->settings['widget_order'] = array(
		...
		'desc'    => __('Drag and drop to order widget providers',$this->WPB_PREFIX),
...
.service-filters .divprovider {
}
.service-filters .divprovider a {
}
.service-filters .divprovider:hover, .service-filters .divprovider.selected,.service-filters .divprovider.completed {
}
.service-filters .divprovider.completed{
}
.ready-label.hidden{ display: none;}
}
.service-filters .divprovider .service-filter-name-container .service-filter-name-outer {
}
.service-filters .divprovider .service-filter-name-container .service-filter-name-outer .service-filter-name-inner {
}
.service-filters .divprovider .service-filter-name-container .service-filter-name-outer .service-filter-name-inner a {
}',
		'type'    => 'code',
		'section' => 'wsi_styling'
	);
