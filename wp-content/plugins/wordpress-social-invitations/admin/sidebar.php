...
<div class="postbox" id="sticky"> 
	<h3 style="cursor: default;" class="nowrap"><?php echo sprintf(__('Support %s', $this->WPB_PREFIX), $this->WPB_PLUGIN_NAME);?> </h3>
		<div class="inside">
				...
				<b><?php echo sprintf(__('Subscribe to our <a href="%s">blog</a> to stay tuned!', $this->WPB_PREFIX), 'http://wp.timersys.com/blog/?utm_medium=sidebar&utm_source=wsi-premium&utm_campaign=wsi');?></b>
								
				<h5><a href="http://support.timersys.com/?utm_medium=sidebar&utm_source=wsi-premium&utm_campaign=wsi" target="_blank">CLICK HERE FOR SUPPORT</a></h5>
