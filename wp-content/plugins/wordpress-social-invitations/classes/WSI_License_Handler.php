...
if ( !class_exists( 'WSI_License' ) ) {
	...
	class WSI_License {
		...
		public function activate_license() {
			...
			if ( !isset( $_POST['wsi_settings'] ) ) return;
			if ( !isset( $_POST['wsi_settings'][$this->item_shortname . '_license_key'] ) ) return;

			if ( get_option( $this->item_shortname . '_license_active' ) == 'valid' && $_POST['wsi_settings'][$this->item_shortname . '_license_key'] == $this->license ) return;

			$license = sanitize_text_field( $_POST['wsi_settings'][$this->item_shortname . '_license_key'] ) ;
