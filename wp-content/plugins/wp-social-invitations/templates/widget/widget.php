...
<h6 class="wsi-title" style="margin:10px 0 0 10px;"><?php echo isset($title) && $title != '' ? $title : apply_filters('wsi_widget_title', sprintf(__('Invite your friends to join %s',$WPB_PREFIX), get_bloginfo('name')));?></h6>
